...
# Modifiable params
iteration_id <- "lamination_0061"
initial_seed <- 5787061
grid_width <- 10
grid_height <- 1
plot_bg <- "#131313"
plot_res <- 100
...
img_rescaled <- img |>
  ...
  magick::image_morphology(method = "Erode", iterations = 3, kernel = "Disk") |>
