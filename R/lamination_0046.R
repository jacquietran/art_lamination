...
# Modifiable params
iteration_id <- "lamination_0046"
initial_seed <- 5787046
grid_width <- 1
grid_height <- 1
plot_bg <- "#131313"
plot_res <- 100
...
ggplot2::ggsave(
  ...
  plots_in_grid, width = 100, height = 100, units = "px",
