...
# Modifiable params
iteration_id <- "lamination_0072"
initial_seed <- 5787072
grid_width <- 6
grid_height <- 1
plot_bg <- "#131313"
plot_res <- 100
...
ggplot2::ggsave(
  ...
  plots_in_grid, width = 600, height = 100, units = "px",
